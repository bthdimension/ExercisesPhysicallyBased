...
//			float dst = abs(it->normal.dot( it->atDiff(0) ));
//			if (dst < distance) {
//				distance = dst;
...
//SupportPoint MeshCollider::supportFunction(MeshCollider *meshCollider, vmml::Vector3f & direction)
//{
//	direction.normalize();
//	SupportPoint sup;
...
//			direction = abc;
//		}
//		else if (not4) { // origin below triangle
//			simplex = { b,c,a };
//			direction = -abc;
//		}
//	}
